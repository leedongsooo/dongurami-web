    ...
    <div class="mx-4 overflow-hidden card card-body blur shadow-blur mt-n6">
      <div class="row gx-4">
        ...
        <div class="col-auto my-auto">
          <div class="h-100">
            <h5 class="mb-1">동구라미</h5>
            <p class="mb-0 text-sm font-weight-bold">중앙동아리 / IT, 코딩</p>
          </div>
        </div>
        <div
  ...
  <div class="py-4 container-fluid">
          ...
          <div class="p-3 card-body">
            <ul class="list-group">
              ...
              >
                ...
                >
                  <h6 class="mb-0 text-sm">일동수</h6>
                  <p class="mb-0 text-xs">Hi!</p>
                </div>
                <a
              ...
              >
                <div
                  class="d-flex align-items-start flex-column justify-content-center"
                >
                  <h6 class="mb-0 text-sm">삼동수</h6>
                  <p class="mb-0 text-xs">About.</p>
                </div>
                <a
                  class="mb-0 btn btn-link pe-3 ps-0 ms-auto"
                  href="javascript:;"
              ...
              >
                <div
                  class="d-flex align-items-start flex-column justify-content-center"
                >
                  <h6 class="mb-0 text-sm">사동수</h6>
                  <p class="mb-0 text-xs">Have</p>
                </div>
                <a
                  class="mb-0 btn btn-link pe-3 ps-0 ms-auto"
                  href="javascript:;"
              ...
              >
                <div
                  class="d-flex align-items-start flex-column justify-content-center"
                >
                  <h6 class="mb-0 text-sm">오동수</h6>
                  <p class="mb-0 text-xs">information..</p>
                </div>
                <a
                  class="mb-0 btn btn-link pe-3 ps-0 ms-auto"
                  href="javascript:;"
    ...
    <div class="mt-4 row">
      <div class="col-12">
        <div class="mb-4 card">
          <div class="p-3 pb-0 card-header">
            <h6 class="mb-1">타 동아리</h6>
            <p class="text-sm">수원대학교 동아리</p>
          </div>
          <div class="p-3 card-body">
            <div class="row">
                ...
                <div class="border card h-100 card-plain">
                  ...
                  >
                    <a href="javascript:;">
                      ...
                      <h5 class="text-secondary">새 동아리</h5>
                    </a>
                  </div>
                </div>
              </div>
